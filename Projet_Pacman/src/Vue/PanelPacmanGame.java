...
public class PanelPacmanGame extends JPanel {
	...
	public void setColorWhite(Color c){
		ghostsColor = c;
	}

	public Color getColorPink(){
		return ghostScarredColor;
	}

	public void setColorPink(Color c){
		ghostScarredColor = c;
	}
	...
	public void updateAgentPositions(ArrayList<PositionAgent> pacmans, ArrayList<PositionAgent> ghosts) {
		this.pacmans_pos = pacmans;
		this.ghosts_pos = ghosts;
		repaint();
	}
